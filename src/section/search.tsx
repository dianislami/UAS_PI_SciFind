...
const Searching: React.FC = () => {
  ...
  return (
    <div className="relative">
      ...
      {/* Result */}
      <div className="max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 mx-auto my-10 z-30">
        <div className="flex justify-center lg:justify-end" style={{ position: 'relative' }}>
          <div className="relative">
            {/* Text overlay */}
            <div className="absolute inset-0 flex flex-col justify-center m-4 sm:m-6 md:m-8 lg:m-12 text-left z-100">
